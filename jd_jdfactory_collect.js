...
cron "1 * * * *" jd_jdfactory_collect.js
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.data.bizCode === 0) {
              ...
              console.log(`algorithm 异常：${JSON.stringify(data)}`)
            }
          }
        }
      } catch (e) {
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.data.bizCode === 0) {
              ...
              console.log(`jdfactory_makeProduct 异常：${JSON.stringify(data)}`)
            }
          }
        }
      } catch (e) {
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.data.bizCode === 0) {
              ...
              console.log(`jdfactory_getProductList 异常：${JSON.stringify(data)}`)
            }
          }
        }
      } catch (e) {
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.data.bizCode === 0) {
              ...
              console.log(`jdfactory_getHomeData 异常：${JSON.stringify(data)}`)
            }
          }
        }
      } catch (e) {
